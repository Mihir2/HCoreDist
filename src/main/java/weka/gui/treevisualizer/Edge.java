...
public class Edge {
  ...
  /**
   * This constructs an Edge with the specified label and parent , child serial
   * tags.
   * 
  ...
  /**
   * This function is called to break the label of the edge up in to seperate
   * lines
   */
