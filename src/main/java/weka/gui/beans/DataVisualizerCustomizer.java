...
/**
 * GUI customizer for data visualizer. Allows the customization of
 ...
 * @version $Revision$
 */
public class DataVisualizerCustomizer extends JPanel implements
   ...
   * Constructor
   */
  public DataVisualizerCustomizer() {
    ...
    okBut.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (m_modifyListener != null) {
          m_modifyListener.
            setModifiedStatus(DataVisualizerCustomizer.this, true);
        }
        if (m_parent != null) {
          m_parent.dispose();
        }
  ...
  public void customizerClosing() {
    ...
    m_dataVis.setOffscreenYAxis(m_yAxisBack);
